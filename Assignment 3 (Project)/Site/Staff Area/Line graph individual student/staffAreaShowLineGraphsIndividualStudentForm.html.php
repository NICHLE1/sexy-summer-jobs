...
?>
    ...
    <!--
    This file is controlled by the staffAreaShowLineGraphsByIndividualStudentForm.php file. It is intended to provide a user interface to submit the student name.
-->
    ...
    <head>
        ...
        <title>Staff Area | Individual Student Line Graphs</title>
    </head>
    ...
    <body>
        ...
        <div class="pageheaderbox">
            <h1 class="pageheader">Show line graphs by student</h1>
        </div>
        ...
        <div class="formContainer">
            <form class='formStyles' action='staffAreaShowLineGraphsIndividualStudentController.php' method='POST'>
                <fieldset>
                    <legend>Show Line Graphs</legend>
                    ...
                    <select name="showLineGraphsByStudent" required>
            ...
            ?>
                    ...
                    <input class="submitButton" type="submit" name="showLineGraphConfirmation" value="Show line graph">
                </fieldset>
            </form>
        </div>
    </body>
