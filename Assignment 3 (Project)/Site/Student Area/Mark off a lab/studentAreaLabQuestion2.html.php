<!--
    This file is the second question on the grid. Its controller is he studentAreaLabQuestionsController.php file
-->
...
<head>
    ...
    <title>Student Area | Question Two</title>
</head>

<body>

    <div class="pageheaderbox">
        <h1 class="pageheader">Question two</h1>
    </div>
    <form action='studentAreaLabQuestionsController.php' method='POST'>

        <!--<a href="#" id="des1">deselect circles (method 1)</a>-->

        <h2 class="northLabel">Content was familiar</h2>
        ...
        <div class="gridImage">
            <h2 class="westLabel">Didn't know how to approach these problems</h2>
            <img class="grid" src="../../assets/images/graphImages/graphTemplate.png" alt="Question two" usemap="#graph_map" draggable="false">
            <h2 class="eastLabel">Had a clear plan for these problems</h2>
        </div>
        <h2 class="southLabel">Content was all new</h2>
        <map name="graph_map">
        ...
        <div class="skipButtonQuestionContainer">
            <input class="skipButtonQuestionPage" type="submit" name="checkpointComplete" value="Skip question two">
        </div>

        <br>
        <div class="submitButtonQuestionContainer">
            <input class="submitButtonQuestionPage" type="submit" name="checkpointComplete" value="Submit question two" id="submitQuestion" disabled selected>
        </div>

        <input type="hidden" name="tool2Student" value="<?php echo $_POST['tool1Student'] ?>">
        <input type="hidden" name="tool2Lab" value="<?php echo $_POST['tool1Lab'] ?>">
