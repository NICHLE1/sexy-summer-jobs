<!--
    Comments:    This file has a limited but important purpose. It is intended to appear if an error was found in the createTeamNZ.php file
...
<!--This page only activates if an error is found, and it will display a relevant message according to the source of the problem.-->
    <p>
        <?php echo $error . "<br/>" . $e->getMessage(); ?> <!-- The variable is taken from the createTeamNZ.php file -->
    </p>
</body>
</html>