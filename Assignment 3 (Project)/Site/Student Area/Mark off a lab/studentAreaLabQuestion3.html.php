<!--
    This file is the third question on the grid. Its controller is he studentAreaLabQuestionsController.php file
-->
...
<head>
    ...
    <link rel="stylesheet" href="../../assets/goldbootstrap-master/css/goldbootstrap.css" media="screen">
    <title>Student Area | Question Three</title>
</head>

<body>

    <div class="pageheaderbox">
        <h1 class="pageheader">Question three</h1>
    </div>

    <form action='studentAreaLabQuestionsController.php' method='POST'>

        <!--<a href="#" id="des1">deselect circles (method 1)</a>-->
        <h2 class="northLabel">My programming skills have improved</h2>
        ...
        <div class="gridImage">
            <h2 class="westLabel">Frustrated</h2>
            <img class="grid" src="../../assets/images/graphImages/graphTemplate.png" alt="Question three" usemap="#graph_map" draggable="false">
            <h2 class="eastLabel">Triumphant</h2>
        </div>
        <h2 class="southLabel">My programming skills have not improved</h2>
        <map name="graph_map">
        ...
        <div class="skipButtonQuestionContainer">
            ...
            <input class="skipButtonQuestionPage" type="submit" name="checkpointComplete" value="Skip question three">
        </div>

        <br>

        <div class="submitButtonQuestionContainer">
            <input class="submitButtonQuestionPage" type="submit" name="checkpointComplete" value="Submit question three" id="submitQuestion" disabled selected>

        </div>

        <input type="hidden" name="tool3Student" value="<?php echo $_POST['tool2Student'] ?>">
        <input type="hidden" name="tool3Lab" value="<?php echo $_POST['tool2Lab'] ?>">
