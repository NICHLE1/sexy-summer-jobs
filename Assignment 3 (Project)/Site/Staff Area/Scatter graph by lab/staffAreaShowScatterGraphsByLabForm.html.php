...
?>
    ...
    <!--
    This file is controlled by the staffAreaShowScatterGraphsByLabController.php file. It is intended to provide a user interface to submit the lab number.
-->
    ...
    <head>
        ...
        <title>Staff Area | Show Scatter Graphs By Lab</title>
    </head>
    ...
    <body>
        ...
        <div class="pageheaderbox">
            <h1 class="pageheader">Show scatter graphs by lab</h1>
        </div>
        ...
        <div class="formContainer">
            <form class='formStyles' action='staffAreaShowScatterGraphsByLabController.php' method='POST'>
                <fieldset>
                    <legend>Show Scatter Graphs</legend>

                    <i>Only lab numbers with actual results are displayed in the dropdown</i>

                    <!-- The select tag, which starts up the ability to select an option from a dropdown menu-->
                    <select name="showScatterGraphsByLab" required>
