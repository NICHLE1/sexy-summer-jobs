...
?>
    ...
    <!--
This file is controlled by the staffAreaShowScatterGraphsByLabController.php file.  It is intended to output the results from the select statements.
-->
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function drawChart1() {
                var data1 = google.visualization.arrayToDataTable([
                    ...
                    <?php
         foreach($showScatterGraphByLabsTool1Result as $row)
          {
              echo ("[$row[0], $row[1]],");
          }
          ?>
        ...
        <script type="text/javascript">
            ...
            function drawChart2() {
                var data2 = google.visualization.arrayToDataTable([
                    ...
                    <?php
         foreach($showScatterGraphByLabsTool2Result as $row)
          {
              echo ("[$row[0], $row[1]],");
          }
          ?>
        ...
        <script type="text/javascript">
            ...
            function drawChart3() {
                var data3 = google.visualization.arrayToDataTable([
                    ...
                    <?php
         foreach($showScatterGraphByLabsTool3Result as $row)
          {
              echo ("[$row[0], $row[1]],");
          }
          ?>
        ...
        <title>Staff Area | Scatter Graphs</title>
    </head>
    ...
    <body>
        ...
        <?php
  if($showScatterGraphByLabsTool1ResultRowCount > 0)
  {
  ...
  if($showScatterGraphByLabsTool2ResultRowCount > 0)
  {
  ...
  if($showScatterGraphByLabsTool3ResultRowCount > 0)
  {
