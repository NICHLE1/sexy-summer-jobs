...
?>
    ...
    <!--
    This file is controlled by the staffAreaClassAverageResponseAllLabsController.php file. Its purpose is to output the graphs based on the select queries.
-->
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function drawChart1() {
                var data1 = google.visualization.arrayToDataTable([
                    ...
                    <?php
         foreach($showLineGraphAverageAllLabsTool1Result as $row)
          {
              echo ("[$row[0], $row[1]],");
          }
          ?>
        ...
        <script type="text/javascript">
            ...
            function drawChart2() {
                var data2 = google.visualization.arrayToDataTable([
                    ...
                    <?php
         foreach($showLineGraphAverageAllLabsTool2Result as $row)
          {
              echo ("[$row[0], $row[1]],");
          }
          ?>
        ...
        <script type="text/javascript">
            ...
            function drawChart3() {
                var data3 = google.visualization.arrayToDataTable([
                    ...
                    <?php
         foreach($showLineGraphAverageAllLabsTool3Result as $row)
          {
              echo ("[$row[0], $row[1]],");
          }
          ?>
        ...
        <script type="text/javascript">
            ...
            function drawChart4() {
                var data4 = google.visualization.arrayToDataTable([
                    ...
                    <?php
         foreach($showLineGraphAverageAllLabsTool4Result as $row)
          {
              echo ("[$row[0], $row[1]],");
          }
          ?>
        ...
        <script type="text/javascript">
            ...
            function drawChart5() {
                var data5 = google.visualization.arrayToDataTable([
                    ...
                    <?php
         foreach($showLineGraphAverageAllLabsTool5Result as $row)
          {
              echo ("[$row[0], $row[1]],");
          }
          ?>
        ...
        <script type="text/javascript">
            ...
            function drawChart6() {
                var data6 = google.visualization.arrayToDataTable([
                    ...
                    <?php
         foreach($showLineGraphAverageAllLabsTool6Result as $row)
          {
              echo ("[$row[0], $row[1]],");
          }
          ?>
        ...
        <title>Staff Area | Average Response Across All Labs</title>
    </head>
    ...
    <body>
        ...
        <?php
    if($showLineGraphAverageAllLabsTool1ResultRowCount > 0)
    {
    ...
    if($showLineGraphAverageAllLabsTool2ResultRowCount > 0)
    {
    ...
    if($showLineGraphAverageAllLabsTool3ResultRowCount > 0)
    {
    ...
    else
    {
      echo ("<h3>No result found for graph 3 <br> <br></h3>");
        ...
        if($showLineGraphAverageAllLabsTool4ResultRowCount > 0)
    {
    ...
    if($showLineGraphAverageAllLabsTool5ResultRowCount > 0)
    {
    ...
    if($showLineGraphAverageAllLabsTool6ResultRowCount > 0)
    {
