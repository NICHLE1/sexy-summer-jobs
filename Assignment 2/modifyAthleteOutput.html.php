<!-- 
    This page will display the output based on what the user inputted into all the different fields on the modifyAthlete.html.php page. 
    The modifyAthleteController.php file decides what to select from the database.
-->
...
<body>
    ...
    <div class="pageheaderbox">
        <h1 class="pageheader">Modify Athlete Page Output</h1>
    </div>

<table>
    <tr>
        <!-- Sets up headings for the table -->
        <th class="tableheadercolouring">First Name</th><th class="tableheadercolouring">Last Name</th><th class="tableheadercolouring">Position</th><th class="tableheadercolouring">Gender</th><th class="tableheadercolouring">Image</th><th class="tableheadercolouring">Team Name</th><th class="tableheadercolouring">Country</th>
    </tr>
        <?php

            // Below is a foreach loop that will echo out values passed over from the modifyAthleteController.php file
            foreach($modifiedAthleteResult as $row)
            {
                //print_r($row);
                //echo"<br>";
